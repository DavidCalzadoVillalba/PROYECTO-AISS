...
public class CommentController {
    ...
    public ResponseEntity<Comment> findOne(@PathVariable @NonNull String id) throws VideoMinerException {
    ...
    public ResponseEntity<List<Comment>> findByVideoId(@PathVariable @NonNull String videoId) throws VideoMinerException {
